                    ...
                    <aside className="about-sidebar">
                        <ScrollReveal direction="right" delay={0.5}>
                            <div style={{ position: 'sticky', top: 'calc(var(--nav-height) + 2rem)' }}>
                                ...
                                <div className="beauty-card" style={{ margin: '2rem 0 0', padding: '2rem' }}>
                                    <h4 style={{ fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '2px', color: 'var(--text-muted)', marginBottom: '1.5rem' }}>Full Scholarly Definition</h4>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                        {[
                                            { l: 'W', w: 'Worldwide' },
                                            { l: 'I', w: 'Interdisciplinary' },
                                            { l: 'S', w: 'Scholarship' },
                                            { l: 'D', w: 'Discoveries' },
                                            { l: 'O', w: 'Original' },
                                            { l: 'M', w: 'Manuscripts' }
                                        ].map((item, i) => (
                                            <div key={i} style={{ display: 'flex', alignItems: 'baseline', gap: '12px', borderBottom: i < 5 ? '1px solid var(--border)' : 'none', paddingBottom: i < 5 ? '0.5rem' : '0' }}>
                                                <span style={{ 
