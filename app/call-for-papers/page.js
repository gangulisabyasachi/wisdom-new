        ...
        <section style={{ padding: '6rem 0' }}>
            <div className="container">
                ...
                <div className="steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem' }}>
                    {steps.map((step, idx) => (
                        <div key={idx} className="beauty-card" style={{ margin: 0, padding: '2.5rem', textAlign: 'center', borderTop: '4px solid var(--accent)' }}>
        ...
        <section style={{ padding: '8rem 0' }}>
            <div className="container">
                <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <div className="beauty-card reveal" style={{ marginTop: '4rem', padding: '3rem', background: 'linear-gradient(135deg, var(--bg-subtle), var(--bg-card))', border: '1px solid var(--accent)', boxShadow: '0 10px 30px -10px var(--accent-light)', textAlign: 'left' }}>
        ...
        <section style={{ background: '#0f172a', color: 'white', padding: '6rem 0' }}>
            <div className="container" style={{ textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center' }}>
                    <a href="https://forms.gle/3wqdvAt5XR8h5hBJ6" target="_blank" className="btn btn-primary" style={{ padding: '1.25rem 3rem' }}>Apply for Manuscript ID</a>
